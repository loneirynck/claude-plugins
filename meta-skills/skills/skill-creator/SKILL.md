...
- `shared/skill-conventions/conventions.yaml` — naming rules, description patterns, validation checklist, shared infra imports
...
1. Generate a kebab-case name. Validate against rules in `shared/skill-conventions/conventions.yaml`.
2. Draft a trigger-focused description (verb-first, 20-40 words). Follow good/bad examples from `shared/skill-conventions/conventions.yaml`.
